...
@Getter
@Setter
public class InterventionRecommended extends DataElement {
  ...
  private String qdmTitle = "Intervention, Recommended";
  private String hqmfOid = "2.16.840.1.113883.10.20.28.4.37";
