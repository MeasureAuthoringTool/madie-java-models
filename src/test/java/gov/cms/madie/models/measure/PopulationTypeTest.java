...
class PopulationTypeTest {
  ...
  void fromDisplay() {
    assertThat(
        PopulationType.fromDisplay("Initial Population"),
        is(equalTo(PopulationType.INITIAL_POPULATION)));
    ...
    assertThat(
        PopulationType.fromDisplay("Measure Population"),
        is(equalTo(PopulationType.MEASURE_POPULATION)));
    assertThat(
        PopulationType.fromDisplay("Measure Observation"),
        is(equalTo(PopulationType.MEASURE_OBSERVATION)));
  ...
  void fromCode() {
    assertThat(
        PopulationType.fromCode("initial-population"),
        is(equalTo(PopulationType.INITIAL_POPULATION)));
    ...
    assertThat(
        PopulationType.fromCode("measure-population"),
        is(equalTo(PopulationType.MEASURE_POPULATION)));
    assertThat(
        PopulationType.fromCode("measure-observation"),
        is(equalTo(PopulationType.MEASURE_OBSERVATION)));
